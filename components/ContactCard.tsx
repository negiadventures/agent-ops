    ...
    <section id="contact" className="border-t border-line">
      <div className={`mx-auto ${container} px-6 py-20`}>
        <div className="max-w-2xl">
          ...
          <p className="mt-3 text-[15px] leading-relaxed text-muted">{pitch}</p>

          {state === "sent" ? (
            <div
              role="status"
              className="mt-8 rounded-xl border border-line bg-white/[0.02] px-5 py-6"
            >
              <p className="text-[15px] font-medium text-fg">Message sent.</p>
              <p className="mt-1 text-[14px] text-muted">
                You&rsquo;ll get a reply at the address you gave, usually within
                a day or two.
              </p>
            </div>
          ) : (
            <form
              onSubmit={onSubmit}
              className="mt-8 rounded-xl border border-line bg-white/[0.02] p-5 sm:p-6"
            >
